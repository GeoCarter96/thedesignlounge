...
<div className="flex-1 overflow-y-auto pr-4 custom-scrollbar">
  <nav className="flex flex-col gap-10">
    {['The Lobby', 'Freebies', 'Testimonials',  'Courses', 'Ebooks','Flyers','Planners','PrivateLounge', 'Lounge Menu','Owner','CustomWork', 'Contact'].map((item, i) => (
      <motion.div
        key={item}
      ...
      >
        <Link 
          href={item === 'The Lobby' ? '/'  : item === 'Lounge Menu' 
